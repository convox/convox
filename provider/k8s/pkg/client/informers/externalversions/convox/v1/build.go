...
import (
	...
	versioned "github.com/convox/convox/provider/k8s/pkg/client/clientset/versioned"
	internalinterfaces "github.com/convox/convox/provider/k8s/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/convox/convox/provider/k8s/pkg/client/listers/convox/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ConvoxV1().Builds(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConvoxV1().Builds(namespace).Watch(context.TODO(), options)
			},
		},
		&convoxv1.Build{},
		resyncPeriod,
