...
// StatusAll provides a mock function with given fields:
func (_m *MockInterface) StatusAll() ([]AtomStatusInfo, error) {
	ret := _m.Called()

	var r0 []AtomStatusInfo
	if rf, ok := ret.Get(0).(func() []AtomStatusInfo); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]AtomStatusInfo)
		}
	}
