...
import (
	...
	stdapi "github.com/convox/stdapi"

	stdsdk "github.com/convox/stdsdk"

	structs "github.com/convox/convox/pkg/structs"
...
func (_m *Interface) BalancerList(app string) (structs.Balancers, error) {
	ret := _m.Called(app)

	var r0 structs.Balancers
	if rf, ok := ret.Get(0).(func(string) structs.Balancers); ok {
		r0 = rf(app)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(structs.Balancers)
		}
	}
...
func (_m *Interface) InstanceKeyroll() (*structs.KeyPair, error) {
	ret := _m.Called()

	var r0 *structs.KeyPair
	if rf, ok := ret.Get(0).(func() *structs.KeyPair); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*structs.KeyPair)
		}
	}
...
func (_m *Interface) LetsEncryptConfigApply(config structs.LetsEncryptConfig) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(structs.LetsEncryptConfig) error); ok {
		r0 = rf(config)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Interface) LetsEncryptConfigGet() (*structs.LetsEncryptConfig, error) {
	ret := _m.Called()

	var r0 *structs.LetsEncryptConfig
	if rf, ok := ret.Get(0).(func() *structs.LetsEncryptConfig); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_m *Interface) MetricsByService(app string, services []string, opts structs.MetricsOptions) ([]structs.ServiceMetricsRow, error) {
	ret := _m.Called(app, services, opts)

	var r0 []structs.ServiceMetricsRow
	if rf, ok := ret.Get(0).(func(string, []string, structs.MetricsOptions) []structs.ServiceMetricsRow); ok {
		r0 = rf(app, services, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]structs.ServiceMetricsRow)
		}
	}
...
func (_m *Interface) RegistryProxy(ctx *stdapi.Context) error {
	ret := _m.Called(ctx)

	var r0 error
	if rf, ok := ret.Get(0).(func(*stdapi.Context) error); ok {
		r0 = rf(ctx)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Interface) ResourceConsole(app string, name string, rw io.ReadWriter, opts structs.ResourceConsoleOptions) error {
	ret := _m.Called(app, name, rw, opts)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, io.ReadWriter, structs.ResourceConsoleOptions) error); ok {
...
func (_m *Interface) ResourceExport(app string, name string) (io.ReadCloser, error) {
	ret := _m.Called(app, name)
...
func (_m *Interface) ResourceImport(app string, name string, r io.Reader) error {
...
// ServiceLogs provides a mock function with given fields: app, name, opts
func (_m *Interface) ServiceLogs(app string, name string, opts structs.LogsOptions) (io.ReadCloser, error) {
...
func (_m *Interface) ServiceMetrics(app string, service string, opts structs.MetricsOptions) (structs.Metrics, error) {
	ret := _m.Called(app, service, opts)
...
func (_m *Interface) ServiceScaleOverrideSet(app string, service string, active bool, ackBy string) error {
