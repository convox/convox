...
func init() {
	...
	routes["AppManifestService"] = "GET /apps/{app}/manifest/services/{service}"
	routes["AppBudgetGet"] = "GET /apps/{app}/budget"
	routes["AppBudgetSet"] = "POST /apps/{app}/budget"
	routes["AppBudgetClear"] = "DELETE /apps/{app}/budget"
	routes["AppBudgetReset"] = "POST /apps/{app}/budget/reset"
	routes["AppBudgetShutdownStateGet"] = "GET /apps/{app}/budget/shutdown-state"
	routes["AppBudgetSimulate"] = "POST /apps/{app}/budget/simulate-shutdown"
	routes["AppBudgetDismissRecovery"] = "POST /apps/{app}/budget/dismiss-recovery"
	routes["AppCost"] = "GET /apps/{app}/cost"
	...
	routes["ServiceMetrics"] = "GET /apps/{app}/services/{service}/metrics"
	routes["ServiceRestart"] = "POST /apps/{app}/services/{name}/restart"
	routes["ServiceScaleOverrideSet"] = "POST /apps/{app}/services/{service}/scale-override"
	routes["ServiceTriggersDisable"] = "POST /apps/{app}/services/{service}/triggers/disable"
	routes["ServiceTriggersEnable"] = "POST /apps/{app}/services/{service}/triggers/enable"
	routes["ServiceTriggersThresholdSet"] = "POST /apps/{app}/services/{service}/triggers/threshold"
