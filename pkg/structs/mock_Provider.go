...
func (_m *MockProvider) AppConfigGet(app string, name string) (*AppConfig, error) {
...
func (_m *MockProvider) AppConfigList(app string) ([]AppConfig, error) {
	ret := _m.Called(app)

	var r0 []AppConfig
	if rf, ok := ret.Get(0).(func(string) []AppConfig); ok {
		r0 = rf(app)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]AppConfig)
...
func (_m *MockProvider) AppConfigSet(app string, name string, valueBase64 string) error {
...
func (_m *MockProvider) BalancerList(app string) (Balancers, error) {
	...
	var r0 Balancers
	if rf, ok := ret.Get(0).(func(string) Balancers); ok {
		r0 = rf(app)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(Balancers)
		}
	}
...
func (_m *MockProvider) InstanceKeyroll() (*KeyPair, error) {
	...
	var r0 *KeyPair
	if rf, ok := ret.Get(0).(func() *KeyPair); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_m *MockProvider) LetsEncryptConfigApply(config LetsEncryptConfig) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(LetsEncryptConfig) error); ok {
		r0 = rf(config)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *MockProvider) LetsEncryptConfigGet() (*LetsEncryptConfig, error) {
	...
	var r0 *LetsEncryptConfig
	if rf, ok := ret.Get(0).(func() *LetsEncryptConfig); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*LetsEncryptConfig)
		}
	}
...
func (_m *MockProvider) ServiceLogs(app string, name string, opts LogsOptions) (io.ReadCloser, error) {
