...
FROM golang:1.24.13 AS development
...
RUN curl -Ls https://dl.k8s.io/release/v1.34.0/bin/linux/$KUBECTL_ARCH/kubectl -o /usr/bin/kubectl && \
...
FROM golang:1.24.13 AS package
