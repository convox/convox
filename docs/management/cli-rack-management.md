...
| Node group desired size (AWS) | Raises a node group's running size to meet a newly raised minimum | `NOTICE: raising node group my-rack-additional-0-a1b2c3d4e5f60718 desired size to 3 before apply` |
