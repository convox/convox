...
description: "The docker_hub_password GCP rack parameter sets the Docker Hub authentication token, used with docker_hub_username to enable authenticated image pulls."
slug: docker_hub_password
url: /configuration/rack-parameters/gcp/docker_hub_password
---
...
See [docker_hub_username](/configuration/rack-parameters/gcp/docker_hub_username) for the companion parameter.
