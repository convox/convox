...
description: "The webhook_signing_key GCP rack parameter sets a per-Rack HMAC secret that signs outbound webhook deliveries with a Convox-Signature header, unset by default."
slug: webhook_signing_key
url: /configuration/rack-parameters/gcp/webhook_signing_key
---
...
- [docker_hub_password](/configuration/rack-parameters/gcp/docker_hub_password): Another Rack-level credential stored as a Kubernetes Secret and masked in parameter output.
