...
| [prometheus_url](/configuration/rack-parameters/aws/prometheus_url)                 | External Prometheus URL for KEDA autoscale and `convox ps` GPU enrichment. Customer must set explicitly post-3.24.6 (no auto-resolution). |
