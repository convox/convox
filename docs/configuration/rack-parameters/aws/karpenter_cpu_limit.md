...
description: "The karpenter_cpu_limit AWS rack parameter sets the maximum total vCPUs Karpenter can provision across all workload nodes, defaulting to 100."
