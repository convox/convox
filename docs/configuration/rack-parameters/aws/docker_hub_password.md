...
description: "The docker_hub_password AWS rack parameter sets the Docker Hub authentication token, used with docker_hub_username to enable authenticated image pulls."
