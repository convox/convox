---
title: "syslog"
description: "The syslog Digital Ocean rack parameter sets the endpoint to forward rack logs to a syslog server, such as tcp+tls://example.org:1234, disabled by default."
slug: syslog
