...
description: "The fluentd_memory Azure rack parameter sets the memory request and limit for the Fluentd log collector DaemonSet, defaulting to 200Mi."
slug: fluentd_memory
url: /configuration/rack-parameters/azure/fluentd_memory
---
...
## See Also
- [syslog](/configuration/rack-parameters/azure/syslog) for forwarding logs to an external syslog endpoint
