...
You will first need to establish connectivity between your racks in your given cloud environment.  Under standard conditions rack's will be installed in seperate VPCs. Connectivity is most commonly accomplished via VPC Peering and configuration of routes, and security groups.
