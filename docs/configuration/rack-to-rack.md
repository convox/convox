...
Using Convox’s [internal_router](/configuration/rack-parameters/aws/internal_router) rack parameter along with the service [internalRouter](/reference/primitives/app/service) attribute, you can enable private communication between racks/clusters on your cloud platform. You can complete this in a few steps:
