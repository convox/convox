...
- [3.25 Releases](/reference/releases/3-25) - K8s 1.35, stateful services, Azure cost tracking, Karpenter NodeOverlays, GCP GPU and Cloud TPU node pools, App network isolation, deploy failure detection, custom AMIs, node volume tuning, CloudWatch log retention
