...
- [3.25 Releases](/reference/releases/3-25) - K8s 1.35, Azure cost tracking, Karpenter NodeOverlays, convox run flags, GCP node pools with GPU and Cloud TPU, GCP GPU observability, multi-arch builds
